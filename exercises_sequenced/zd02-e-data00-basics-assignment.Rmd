...
Cut = quality of cut from fair to ideal (worst to best)

color = quality of color from D to J (best to worst)

clarity = quality of clarity from l1 to IF (best)
...
-   (Worser cuts tend to have larger carat sizes)
