...
-   Within the script editor or a chunk
    ...
    -   `Cmd/Ctrl` + `Shift` + `C`
        ...
        -   comments or uncomments something
...
red square in corner on the right

### **q4** How do you show the "Document Outline" in RStudio?

*Hint*: Try googling "rstudio document outline"

There is a button top right corner undernath publish and ctrl + shift + O
