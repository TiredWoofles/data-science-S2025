...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   As the population increases, the standard error of median income decreases. This trend may exist because there are far more populations in lower ranges than high ranges and because there are more people it tends to be more stable of income compared to smaller populations where a single preson has a stronger pull on the median income.
